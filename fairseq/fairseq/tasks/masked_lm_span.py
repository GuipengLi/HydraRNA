...
class MaskedLMConfig(FairseqDataclass):
    ...
    mean_noise_span_length: int = field(
        default=4,
        metadata={"help": "mean_noise_span_length"},
    )
...
@register_task("masked_lm_span", dataclass=MaskedLMConfig)
class spanMaskedLMTask(FairseqTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        src_dataset, tgt_dataset = spanMaskTokensDataset.apply_mask(
            dataset,
            self.source_dictionary,
